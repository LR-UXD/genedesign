const CSS_EXTERNAL = ['https://unpkg.com/genedesign@2.x/dist/arco.css'];
const JS_EXTERNAL = [
  'https://unpkg.com/vue@3.x/dist/vue.global.prod.js',
  'https://unpkg.com/dayjs@1.x/dayjs.min.js',
  'https://unpkg.com/genedesign@2.x/dist/arco-vue.min.js',
  'https://unpkg.com/genedesign@2.x/dist/arco-vue-icon.min.js',
];
