...
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("script")]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"},[n("span",{class:"token language-javascript"},[s(`
  ...
  `),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},";"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1)])),_:1})]),_:2},[t.locale==="zh-CN"?{name:"description",fn:p(()=>[a[0]||(a[0]=n("p",null,[n("code",null,"selectedKeys"),s(" \u3001 "),n("code",null,"checkedKeys"),s(" \u3001 "),n("code",null,"expandedKeys"),s(" \u5C5E\u6027\u5747\u53EF\u53D7\u63A7\uFF0C\u4E0D\u4EC5\u652F\u6301 "),n("code",null,"v-model"),s(" \uFF0C\u8FD8\u53EF\u4EE5\u5728\u5BF9\u5E94\u7684 "),n("code",null,"select"),s(" / "),n("code",null,"check"),s(" / "),n("code",null,"expand"),s(" \u4E8B\u4EF6\u4E2D\u81EA\u884C\u63A7\u5236\u5982\u4F55\u66F4\u65B0\u5C5E\u6027\u503C\u3002")],-1))]),key:"0"}:{name:"description",fn:p(()=>[a[1]||(a[1]=n("p",null,[s("The "),n("code",null,"selectedKeys"),s(", "),n("code",null,"checkedKeys"),s(", and "),n("code",null,"expandedKeys"),s(" attributes can all be controlled, not only supporting "),n("code",null,"v-model"),s(", but also controlling how to update attribute values in the corresponding "),n("code",null,"select"),s(" / "),n("code",null,"check"),s(" / "),n("code",null,"expand"),s(" events.")],-1))]),key:"1"}]),1032,["title"])}var sa=m(Tn,[["render",An]]);const In={setup(){return{treeData:_([{title:"Trunk 0-0",key:"0-0"},{title:"Trunk 0-1",key:"0-1",children:[{title:"Branch 0-1-1",key:"0-1-1"}]}]),loadMore:o=>new Promise(e=>{setTimeout(()=>{o.children=[{title:"leaf",key:`${o.key}-1`,isLeaf:!0}],e()},1e3)})}}};function Nn(t,a,o,e,y,d){const u=c("a-tree");return g(),h(u,{data:e.treeData,"load-more":e.loadMore},null,8,["data","load-more"])}var Vn=m(In,[["render",Nn]]);const Sn=v({name:"ArcoDemo",components:{VirtualDemo:Vn},setup(){const{locale:t}=w();return{locale:t,getMessage:(o,e)=>t.value==="zh-CN"?o:e}}});function zn(t,a,o,e,y,d){const u=c("virtual-demo"),i=c("cell-demo"),l=c("cell-code"),k=c("code-block");return g(),h(k,{id:"load-more",title:t.getMessage("\u52A8\u6001\u52A0\u8F7D","Dynamic Loading")},b({default:p(()=>[r(i,null,{default:p(()=>[r(u)]),_:1}),r(l,null,{default:p(()=>a[2]||(a[2]=[n("pre",{class:"code-content"},[n("code",{class:"language-lang"},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])],-1)])),_:1})]),_:2},[t.locale==="zh-CN"?{name:"description",fn:p(()=>[a[0]||(a[0]=n("p",null,"\u52A8\u6001\u52A0\u8F7D\u8282\u70B9\u3002",-1))]),key:"0"}:{name:"description",fn:p(()=>[a[1]||(a[1]=n("p",null,"Load nodes dynamically.",-1))]),key:"1"}]),1032,["title"])}var aa=m(Sn,[["render",zn]]);const Mn={setup(){const t=_(jn),a=_([]),o=_(!1);return{treeData:t,checkedKeys:a,checked:o,onDrop({dragNode:e,dropNode:y,dropPosition:d}){const u=t.value,i=(l,k,f)=>{l.some((C,z,M)=>C.key===k?(f(C,z,M),!0):C.children?i(C.children,k,f):!1)};i(u,e.key,(l,k,f)=>{f.splice(k,1)}),d===0?i(u,y.key,l=>{l.children=l.children||[],l.children.push(e)}):i(u,y.key,(l,k,f)=>{f.splice(d<0?k:k+1,0,e)})}}}},jn=[{title:"Trunk 0-0",key:"0-0",children:[{title:"Leaf 0-0-1",key:"0-0-1"},{title:"Branch 0-0-2",key:"0-0-2",disableCheckbox:!0,children:[{draggable:!1,title:"Leaf 0-0-2-1 (Drag disabled)",key:"0-0-2-1"}]}]},{title:"Trunk 0-1",key:"0-1",children:[{title:"Branch 0-1-1",key:"0-1-1",checkable:!1,children:[{title:"Leaf 0-1-1-1",key:"0-1-1-1"},{title:"Leaf 0-1-1-2",key:"0-1-1-2"}]},{title:"Leaf 0-1-2",key:"0-1-2"}]}];function Pn(t,a,o,e,y,d){const u=c("a-checkbox"),i=c("a-tree");return g(),D($,null,[r(u,{modelValue:e.checked,"onUpdate:modelValue":a[0]||(a[0]=l=>e.checked=l),style:{"margin-bottom":"20px"}},{default:p(()=>a[1]||(a[1]=[s(" checkable ")])),_:1},8,["modelValue"]),r(i,{class:"tree-demo",draggable:"",blockNode:"",checkable:e.checked,data:e.treeData,onDrop:e.onDrop},null,8,["checkable","data","onDrop"])],64)}var Un=m(Mn,[["render",Pn],["__scopeId","data-v-790cc031"]]);const On=v({name:"ArcoDemo",components:{VirtualDemo:Un},setup(){const{locale:t}=w();return{locale:t,getMessage:(o,e)=>t.value==="zh-CN"?o:e}}});function Rn(t,a,o,e,y,d){const u=c("virtual-demo"),i=c("cell-demo"),l=c("cell-code"),k=c("code-block");return g(),h(k,{id:"draggable",title:t.getMessage("\u62D6\u62FD","Draggable")},b({default:p(()=>[r(i,null,{default:p(()=>[r(u)]),_:1}),r(l,null,{default:p(()=>a[2]||(a[2]=[n("pre",{class:"code-content"},[n("code",{class:"language-lang"},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("a-checkbox")]),s(`
