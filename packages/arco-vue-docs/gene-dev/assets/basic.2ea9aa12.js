import{_ as k,g as f,r as c,o as i,i as v,a as l,b as a,t as w,F as y,d as C,u as D,c as V,f as $,w as o,e as n}from"./index.720e0dc3.js";const B={setup(){return{value:f(new Date("2023-01-01"))}}};function x(t,s,p,e,d,m){const u=c("a-calendar");return i(),v(y,null,[l(u,{modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=r=>e.value=r)},null,8,["modelValue"]),a(" select: "+w(e.value),1)],64)}var N=k(B,[["render",x]]);const b=C({name:"ArcoDemo",components:{VirtualDemo:N},setup(){const{locale:t}=D();return{locale:t,getMessage:(p,e)=>t.value==="zh-CN"?p:e}}});function A(t,s,p,e,d,m){const u=c("virtual-demo"),r=c("cell-demo"),g=c("cell-code"),_=c("code-block");return i(),V(_,{id:"basic",title:t.getMessage("\u57FA\u672C\u7528\u6CD5","Basic Usage")},$({default:o(()=>[l(r,null,{default:o(()=>[l(u)]),_:1}),l(g,null,{default:o(()=>s[2]||(s[2]=[n("pre",{class:"code-content"},[n("code",{class:"language-lang"},[a(`
