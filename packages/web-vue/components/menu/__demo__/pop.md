...
.menu-demo a-menu :deep(a-menu-collapse-button) {
  width: 32px;
  height: 32px;
  border-radius: 50%;
}

.menu-demo a-menu:not(a-menu-collapsed) :deep(a-menu-collapse-button) {
  right: 0;
  bottom: 8px;
  transform: translateX(50%);
}

.menu-demo a-menu:not(a-menu-collapsed)::before {
  content: '';
  position: absolute;
  right: 0;
  bottom: 0;
...
.menu-demo a-menua-menu-collapsed {
  width: 48px;
  height: auto;
  padding-top: 24px;
...
.menu-demo a-menua-menu-collapsed :deep(a-menu-collapse-button) {
  right: 8px;
  bottom: 8px;
}
</style>
